...
export type GetCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', code: string, name: string, emoji: string, native: string, capital?: string | null, currency?: string | null, phone: string, continent: { __typename?: 'Continent', code: string, name: string } }> };
...
export type GetCountryQuery = { __typename?: 'Query', country?: { __typename?: 'Country', code: string, name: string, emoji: string, native: string, capital?: string | null, currency?: string | null, phone: string, continent: { __typename?: 'Continent', code: string, name: string }, languages: Array<{ __typename?: 'Language', code: string, name: string, native: string }>, states: Array<{ __typename?: 'State', code?: string | null, name: string }> } | null };
