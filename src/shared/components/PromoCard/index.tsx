  ...
  return (
    ...
    >
      <BlurUpImageBackground source={image} style={{ width: "100%" }}>
        <View className="absolute bottom-0 left-0 z-10 size-full active:bg-brand-mid-20"></View>
        <View className="relative w-full overflow-hidden">
          <Image source={fade} className="w-full" resizeMode="cover" />
          <View className="absolute bottom-0 left-0 size-full flex-1 flex-row items-end gap-3 px-4">
