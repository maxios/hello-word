...
const sampleTestimonials = [
  {
    quote: "This app has completely transformed how I manage my daily fitness routine. The carousel component is smooth and intuitive!",
  ...
  {
    quote: "The meal planning features are incredible. I've never been more organized with my nutrition.",
    author: "Michael Chen",
    role: "Amateur Athlete",
    rating: 5,
  },
  {
    quote: "Outstanding design and user experience. Every interaction feels natural and responsive.",
    ...
    variations: [
      {
        ...
        component: () => (
          <ProductCarousel
            products={sampleProducts.map(p => ({ ...p, discount: undefined, badge: undefined }))}
            config={{
              itemsPerView: 1,
  ...
  },
  {
    ...
    component: () => (
      <View className="space-y-4">
        <Text className="text-high-emphasis font-bold">Loading State:</Text>
        <View className="h-[200px] bg-surface-6 rounded-xl items-center justify-center">
          <Text className="text-medium-emphasis">Loading carousel...</Text>
        </View>
        
        <Text className="text-high-emphasis font-bold mt-4">Empty State:</Text>
        <View className="h-[200px] bg-surface-6 rounded-xl items-center justify-center">
